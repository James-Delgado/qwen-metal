...
public enum BenchDefaults {
    ...
    /// PF-1 prefill attribution: interleaved prefills of the prompt, half
    /// attributed (class-split chunks) + half production reference.
    public static let prefillAttributionRuns = 4
